...
extension SpiderChartThemeDataExtension on SpiderChartThemeData {
  SpiderChartThemeData copyWith({double? strokeWidth, double? pointSize}) {
    return SpiderChartThemeData(
      gridColor: gridColor,
      gridDashedColor: gridDashedColor,
      axisColor: axisColor,
      lineColor: lineColor,
      fillColor: fillColor,
